...
- JCBは公式掲載の実質年率18.00%を前提に元利均等払いで計算します。初回手数料は締切翌日の16日から翌月10日までを年365日で日割りし、2回目以降は月利1.50%で計算します。
...
JCBの手数料率はカードの種類により異なります。本ツールのJCBモードは年率18.00%、毎月15日締め・翌月10日払いとして計算します。金融機関休業日やカード固有の条件などにより、実際の請求額とは異なる場合があります。
